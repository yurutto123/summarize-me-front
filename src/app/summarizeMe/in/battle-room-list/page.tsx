					...
					>
						<div className="h-full flex flex-col justify-around items-center">
							<div className="flex justify-center items-center w-full px-3">
								...
								<span className="text-center text-3xl font-extrabold w-2/6">ルーム作成</span>
								<hr className="border-2 border-black w-2/6 mx-2" />
							</div>

							<div className="flex w-full justify-center items-center">
								<span onChange={event => console.log(event.target)} className="font-bold text-2xl">作成時間：</span>
								<select
									id="times"
							...
							<button
								className="w-2/6 rounded-lg font-bold bg-black text-sub-color text-center m-4  px-8 py-4"
							>
								作成
							</button>
