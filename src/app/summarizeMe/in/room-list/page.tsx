	...
	return (
		<div className="w-full">
			<div className="w-9/12 mx-auto my-2 flex justify-around items-center font-bold text-2xl text-sub-color">
				...
				<button onClick={toggleModal} className="bg-origin-blue w-[250px] border-4 border-origin-blue rounded-lg py-2">
					ルーム作成
				</button>
			</div>

			{isOpen && (
				<div onClick={toggleModal} className="bg-slate-500/75 fixed w-full h-full top-0 left-0">
